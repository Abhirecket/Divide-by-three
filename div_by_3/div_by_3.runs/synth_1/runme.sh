...
HD_PWD='C:/Users/abhis/OneDrive/Desktop/my git/Divide-by-three/div_by_3/div_by_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_by_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_by_3.tcl
